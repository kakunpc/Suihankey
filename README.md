...
この度は、「すいはんきー」をお買い上げいただきまして誠にありがとうございます。  
...
次の写真のまるで囲ってある部分にOLEDのジャンパをショートさせる箇所があります。

![image](https://github.com/kakunpc/Suihankey/blob/master/images/4/main.jpg?raw=true)
...
https://config.qmk.fm/#/suihankey/rev1/LAYOUT
